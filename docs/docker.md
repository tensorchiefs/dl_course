...
```
open [http://localhost:8888/?token=\"tensochiefs_rulez\"](http://localhost:8888/?token=\"tensochiefs_rulez\") or [http://localhost:8888/?token=\"tensochiefs_rulez\"](http://192.168.99.100:/?token=\"tensochiefs_rulez\")(for windows) in the browser. 
